...
<body>
    <div>
                ...
                <div class="cont-book">
                    <div class="container-book">
                        ...
                        <div class="action">
                            ...
                            <a href="#take" class="button2-action">Take</a>
                        </div>
                    </div>
                    <div class="container-book">
        ...
        <section id="take" style="display: flex;
        align-items: center;
        justify-content: center;
        height: 900px;
        background-color: #88c9ba;
        margin: 50px 0px;">
            <div>
                <h1>Fill the Form Bellow to Borrow a Book!</h1>
                <div class="form-container">
                    ...
                    <form>
                        ...
                        <button type="button" wire:click="store" style="text-align: center;
                        color: #f4f4f4;
                        text-decoration: none;
                        padding: 5px 7px;
                        background-color: #1a8068;
                        border-radius: 10px;
                        width: 100%;
                        margin-top: 20px;"><b>TAKE</b></button>
                    </form>
                </div>
            </div>
        </section>
